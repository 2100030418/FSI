 ...
 <div class="container1">
    <div class="profile">
      <div class="round-image">
        <img src="viewallfacultybyid.jsp?pid=<%=fty.getId()%>" alt="Profile Picture" width="95%" height="93%"  border-radius="50%"/>
      </div>
      <div class="profile-info">
        <p><strong>Faculty Name:</strong>&ensp;<%= fty.getFname() %></p>
        <p><strong>ID Number:</strong>&ensp;<%=fty.getId() %></p>
	<p><strong>Gender:</strong>&ensp;<%=fty.getGender()%></p>
        <p><strong>Department:</strong>&ensp;<%=fty.getDepartmnt() %></p>
    ...
    <div class="content">
      <h2>Welcome,&ensp;<%=fty.getFname()%></h2>
