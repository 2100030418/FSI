<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.klef.ep.models.Admin" import="java.util.*" import="java.lang.*"%>
...
/* Optional: Hover and focus effects for the button */
.search-button:hover {
...
<form action="viewallfaculties.jsp" method="post">
<div class="search-container">
    
    <input type="text" class="search-bar" placeholder="Search for Id" name="fid" >
...
try {
	...
	Faculty ftid = facultyService1.viewfacultybyid(id);
	
    session.setAttribute("value", ftid);
	...
	<tbody>
                ...
                <tr>
                    <td><%=ftid.getId()%></td>
                    <td><img src="viewallfacultybyid.jsp?pid=<%=ftid.getId()%>"></td>
                    <td><%=ftid.getFname()%></td>
                    <td><%=ftid.getEmail()%></td>
                    <td><%=ftid.getDepartmnt()%></td>
                    <td><a href="adminviewfac.jsp?fid=<%=ftid.getId()%>"><button>View</button></a></td>                   
                </tr>
                
            </tbody>
            
	<% 
    // Rest of your code that uses the 'number' variable
} catch (NumberFormatException e) {
    // Handle the exception here (e.g., set a default value, display an error message)
	...
	for(Faculty fty : ftylist)
	{
		  %>
	            ...
	            <tbody>
	                ...
	                <tr>
	                    <td><%=fty.getId()%></td>
	                    <td><img src="viewallfacultybyid.jsp?pid=<%=fty.getId()%>"></td>
	                    <td><%=fty.getFname()%></td>
	                    <td><%=fty.getEmail()%></td>
    ...
    // Rest of your code using the 'defaultValue' variable
}
%>
