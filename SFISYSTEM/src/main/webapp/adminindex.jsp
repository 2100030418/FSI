...
<table class="faculty-table">
    ...
    try {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sfisystem", "root", "root");
   ...
   <table class="faculty-table">
    ...
    try {
        Class.forName("com.mysql.cj.jdbc.Driver");
        con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/sfisystem", "root", "root");
        Statement stmt1 = con1.createStatement();
        ResultSet rs1 = stmt1.executeQuery("SELECT COUNT(*) as total_count1 FROM faculty_table");
        int totalCount1 = 0;
        if (rs1.next()) {
            totalCount1 = rs1.getInt("total_count1");
        }
        rs1.close();
    ...
    %>
      ...
      <tr> 
        <td class="total-faculty"><%=request.getAttribute("totalCount1")%></td>
    </tr>
