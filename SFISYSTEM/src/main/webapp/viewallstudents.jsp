...
<form action="viewallstudents.jsp" method="post">
<div class="search-container">
    
    <input type="text" class="search-bar" placeholder="Search for Id" name="sid">
...
try {
	...
	Student fty = studentService.getstudentbyid(id);
...
}  // Rest of your code using the 'defaultValue' variabl
%>
